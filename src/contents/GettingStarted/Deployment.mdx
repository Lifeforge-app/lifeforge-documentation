...
| Field                      | Description                                                                                           |
|----------------------------|-------------------------------------------------------------------------------------------------------|
| **TARGET_URL**                | The public URL of your backend API server |
...
<section id="deploying-public-portal">
## Deploying Public Portal

The public portal is a separate frontend application that allows the public to access certain contents in your Lifeforge system. To deploy the public portal, follow the same steps as deploying the frontend, but make sure to copy and paste the environment variables from your <code>.env</code> file to the Vercel dashboard.
</section>
