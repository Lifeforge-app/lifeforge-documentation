...
<Warning className="mb-6">
  <p>
    Due to the rapid development of LifeForge, the architecture of this system is constantly undergoing breaking changes. Therefore, this documentation is extremely outdated for now. I will try to update it as soon as the system is more stable.
  </p>
  <p>
